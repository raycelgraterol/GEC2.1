#pragma checksum "C:\Repositorio\GitRespository\GEC\GEC2.1\src\GECWebApp\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7003d7f97f64748cef57454f64e8eff207c0b5db"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7003d7f97f64748cef57454f64e8eff207c0b5db", @"/Views/Home/Index.cshtml")]
...
#line 9 "C:\Repositorio\GitRespository\GEC\GEC2.1\src\GECWebApp\Views\Home\Index.cshtml"
                                                    Write(ViewBag.sellVe);

#line default
#line hidden
            EndContext();
            BeginContext(283, 652, true);
...
#line 20 "C:\Repositorio\GitRespository\GEC\GEC2.1\src\GECWebApp\Views\Home\Index.cshtml"
                                                    Write(ViewBag.sellVeHigh);

#line default
#line hidden
            EndContext();
            BeginContext(954, 13012, true);
            WriteLiteral(@"</a> Venezuela.
    </div>
  </div>
    ...
    <div class=""card text-white bg-info"">
      <div class=""card-body pb-0"">
        ...
        <div class=""rate-gain"">
          ...
          <input class=""form-control form-control-sm "" type=""number"" style=""width:50%"" id=""valueGainPE"" max=""20"" min=""0"" step=""1"" value=""6"">
        </div>
  ...
  <div class=""col-sm-4 col-lg-3"">
    <div class=""card text-white bg-info"">
      <div class=""card-body pb-0"">
        <button id=""refreshPEU"" onclick=");
            WriteLiteral(@"""exchangeRates.showCountryRate('PE', 'transfers-with-specific-bank', 'USD', $('#valueGainPEU').val(), 'ratePEUVE')"" type=""button"" class=""btn btn-transparent p-0 float-right"">
          <i class=""fa fa-refresh fa-lg""></i>
        </button>
        ...
        <div class=""rate-gain"">
          ...
          <input class=""form-control form-control-sm "" type=""number"" style=""width:50%"" id=""valueGainPEU"" max=""20"" min=""0"" step=""1"" value=""5.5"">
        </div>
        <div id=""ratePEUVELoader"" class=""progress"" style=""display:none;position: absolute;width: 75%;top: 50%;left: 10%;"">
          <div class");
            WriteLiteral(@"=""progress-bar progress-bar-striped progress-bar-animated bg-warning"" role=""progressbar"" style=""width: 70%""></div>
        </div>
        <div>Tasa cambio</div>
    ...
    <div class=""card text-white bg-info"">
      <div class=""card-body pb-0"">
        ...
        <div class=""rate-gain"">
          ...
          <input class=""form-control form-control-sm "" type=""number"" style=""width:50%"" id=""valueGainDO"" max=""20"" min=""1"" step=""1"" value=""6"">
        </div>
 ...
 ");
            WriteLiteral(@"         <i class=""fa fa-refresh fa-lg""></i>
        </button>
        ...
        <div class=""rate-gain"">
          ...
          <input class=""form-control form-control-sm "" type=""number"" style=""width:50%"" id=""valueGainCL"" max=""20"" min=""0"" step=""1"" value=""5"">
        </div>
        <div>Tasa cambio</div>
        ...
        <div id=""rateCLV");
            WriteLiteral(@"EG"" class=""text-value""></div>
    ...
    <div class=""card text-white bg-info"">
      <div class=""card-body pb-0"">
        ...
        <div class=""rate-gain"">
          ...
          <input class=""form-control form-control-sm "" type=""number"" style=""width:50%"" id=""");
            WriteLiteral(@"valueGainMX"" max=""20"" min=""0"" step=""1"" value=""9"">
        </div>
  ...
  <div class=""col-sm-4 col-lg-3"">
    <div class=""card text-white bg-info"">
      <div class=""card-body pb-0"">
        ...
        <div class=""row"">
          <div class=""col-3"">
            <i class=""flag-icon flag-icon-ec ");
            WriteLiteral(@"h1"" title=""ec"" id=""ec""></i>
          </div>
          <div class=""col-9"">
            <div>Tasa Alta</div>
        ...
        <div class=""rate-gain"">
          ...
          <input class=""form-control form-control-sm "" type=""number"" style=""width:50%"" id=""valueGainEC"" max=""20"" min=""0"" step=""1"" value=""6"">
        </div>
  ...
  <div class=""col-sm-4 col-lg-3"">
    <div class=""card text-white bg-info"">
      <div class=""card-body pb-0"">
        <butto");
            WriteLiteral(@"n id=""refreshES"" onclick=""exchangeRates.showCountryRate('ES', 'transfers-with-specific-bank', 'EUR', $('#valueGainES').val(), 'rateESVE')"" type=""button"" class=""btn btn-transparent p-0 float-right"">
          <i class=""fa fa-refresh fa-lg""></i>
        </button>
    ...
    <div class=""card text-white bg-info"">
     ...
     ");
        ...
        <div class=""rate-gain"">
          ...
          <input class=""form-control form-control-sm "" type=""number"" style=""width:50%"" id=""valueGainAR"" max=""20"" min=""0"" step=""1"" value=""9"">
        </div>
...
");
            ...
            DefineSection("Scripts", async() => {
                BeginContext(13984, 4, true);
                WriteLiteral("\r\n  ");
                EndContext();
                BeginContext(13988, 49, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b2c160773cb54a679e1a7e23e25c02ac", async() => {
                }
                );
                ...
                EndContext();
                BeginContext(14037, 135, true);
                WriteLiteral("\r\n  <script>\r\n    $(document).ready(function () {\r\n      exchangeRates.hideGain()\r\n      console.log(\"ready!\");\r\n    });\r\n  </script>\r\n");
                EndContext();
            }
            );
            BeginContext(14175, 4, true);
            WriteLiteral("\r\n\r\n");
            EndContext();
        }
